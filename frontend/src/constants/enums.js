export const FAULT_TYPES = [
  ...
  { value: 'performance/slow',   label: 'Performance / Slow' },
  { value: 'data error',         label: 'Data Error' },
  { value: 'total outage',       label: 'Total Outage' },
  { value: 'partial/degraded',   label: 'Partial / Degraded' },
  { value: 'cosmetic/UI',        label: 'Cosmetic / UI' },
